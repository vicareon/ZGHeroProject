...
} = require('ts-node/dist-raw/node-primordials');
const { extname } = require('path');
const { getOptionValue } = require('ts-node/dist-raw/node-options');
...
const { getPackageType } = require('ts-node/dist-raw/node-esm-resolve-implementation.js').createResolve({tsExtensions: [], jsExtensions: []});
const { URL, fileURLToPath } = require('url');
const { ERR_UNKNOWN_FILE_EXTENSION } = require('ts-node/dist-raw/node-errors').codes;
