...
let arg;
const util_2 = require("ts-node/dist/util");
const repl_1 = require("ts-node/dist/repl");
const index_1 = require("ts-node");
const node_cjs_helpers_1 = require("ts-node/dist-raw/node-cjs-helpers");
const spawn_child_1 = require("ts-node/dist/child/spawn-child");
...
function phase4(payload) {
    ...
    if (isInChildProcess)
        require('ts-node/dist/child/child-loader').lateBindHooks((0, index_1.createEsmHooks)(service));
