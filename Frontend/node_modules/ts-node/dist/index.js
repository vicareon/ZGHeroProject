...
const util_1 = require("ts-node/dist/util");
const configuration_1 = require("ts-node/dist/configuration");
const module_type_classifier_1 = require("ts-node/dist/module-type-classifier");
const resolver_functions_1 = require("ts-node/dist/resolver-functions");
const cjs_resolve_filename_hook_1 = require("ts-node/dist/cjs-resolve-filename-hook");
var repl_1 = require("ts-node/dist/repl");
...
let assertScriptCanLoadAsCJS = engineSupportsPackageTypeField
    ? require('ts-node/dist-raw/node-cjs-loader-utils').assertScriptCanLoadAsCJSImpl
    : () => {
        /* noop */
    };
/**
 ...
 */
exports.VERSION = require('ts-node/package.json').version;
/**
 ...
 */
const createEsmHooks = (tsNodeService) => require('ts-node/dist/esm').createEsmHooks(tsNodeService);
