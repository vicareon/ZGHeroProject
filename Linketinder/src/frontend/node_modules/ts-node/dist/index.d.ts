...
import type { TSCommon } from 'ts-node/dist/ts-compiler-types';
import type { createEsmHooks as createEsmHooksFn } from 'ts-node/dist/esm';
export { TSCommon };
export { createRepl, CreateReplOptions, ReplService, EvalAwarePartialHost, } from 'ts-node/dist/repl';
export type { TranspilerModule, TranspilerFactory, CreateTranspilerOptions, TranspileOutput, TranspileOptions, Transpiler, } from 'ts-node/dist/transpilers/types';
export type { NodeLoaderHooksAPI1, NodeLoaderHooksAPI2, NodeLoaderHooksFormat, } from 'ts-node/dist/esm';
/**
