...
const { createResolve, } = require('ts-node/dist-raw/node-esm-resolve-implementation');
const { defaultGetFormat } = require('ts-node/dist-raw/node-esm-default-get-format');
