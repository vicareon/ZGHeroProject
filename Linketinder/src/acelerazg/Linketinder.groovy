...
//teste de criação e inserção de candidatos na lista
...
//teste de criação e inserção de empresas na lista
...
PessoaJuridica testeEmpresa = new PessoaJuridica("nome", "email", "cep", "estado", "pais", "descricao", "senha", "cnpj")
Vaga vaga = new Vaga("nome", "estado", "descricao")
vaga.setNomeEmpresa(testeEmpresa)
println(vaga.getNomeEmpresa())*/